...
export default function ScrollingText() {
    return (
      <div className="relative overflow-hidden bg-[#60bfff] whitespace-nowrap h-20 md:h-28 lg:h-36 ">
        ...
        <div className="">
          Visit our aircraft page to explore the S-A2. We launched our latest eVTOL vehicle product concept at CES 2024. Visit our aircraft page to explore the S-A2.
        </div>
        <div className="">
          Visit our aircraft page to explore the S-A2. We launched our latest eVTOL vehicle product concept at CES 2024. Visit our aircraft page to explore the S-A2.
        </div>
